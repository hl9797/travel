...
<head>
	...
	<meta charset="UTF-8">
	<meta name="keywords" content="网红，旅游，景点信息,旅游资讯"/>
	<meta name="description" content="网红景点，旅游，景点信息,旅游资讯"/>
	<title>首页  - 网红景点推荐网</title>
...
<body>
	...
	<div class="page">
			...
			<nav class="navbar navbar-default navbar-fixed-top">
				<div class="container">
					...
					<div class="collapse navbar-collapse"
						...
						<!-- 全站搜索 -->
						<form class="navbar-form navbar-left" role="search" action="http://localhost:8080/travel/index.jsp" method="get" target="_blank" class="bdcs-search-form" autocomplete="off" id="bdcs-search-form">
						...
						<iframe class="nav navbar-nav navbar-right" width="190"
							...
							src="http://i.tianqi.com/index.php?c=code&id=12&bdc=%23&icon=1&py=wuhan&num=5">
						</iframe>
					</div>
					<!-- /.navbar-collapse -->
				</div>
		...
		<div id="myCarousel" class="carousel slide banner"
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					...
					<img class="first-slide" id="banner-img" src="image/banner/chakayanhu.jpg" alt="" title="">
					</a>
				</div>
			</div>
		...
		<img src="public/img/sea-hot.png" class="center-block sea-hot" width="200px" height="110px" />
		<!-- 景点展示-->
		...
		<img src="public/img/play.png" class="center-block sea-hot" width="200px" height="110px" />
		<!-- jingdian玩乐-->
		<div class="more-scen">
			<div class="container">
				<div class="row">
						...
						<div class="col-md-6 arround center-block">
							...
							<ul class="arround-scen">
								<li class="col-md-3 col-sm-3 col-xs-3"><a
									href="huanlegu.jsp">欢乐谷</a>
								</li>
								<li class="col-md-3 col-sm-3 col-xs-3"><a
									href=""></a>
								</li>
								<li class="col-md-3 col-sm-3 col-xs-3"><a
									href="dishini.jsp">迪士尼</a>
								</li>
								...
								<li class="col-md-3 col-sm-3 col-xs-3"><a
									href="hellokitty.jsp">helloKitty</a>
								</li>
