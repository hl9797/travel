...
<body>
	...
	<div class="page">
		...
		<!-- 导航结束 -->
							...
							<section class="cntr">
								<div class="cntr mt20">
									<ul class="pgwSlideshow">
										<li><img src="image/scen/meirenyudao.jpg" alt="美人鱼岛"/></li>
										<li><img src="image/scen/datang.jpg" alt="大唐不夜城" height="300px"/></li>
										<li><img src="image/scen/baishatan.jpg" alt="马达京白沙滩" height="300px"/></li>
										<li><img src="image/scen/kapalai.jpg" alt="卡帕莱度假村" height="300px"/></li>
										<li><img src="image/scen/dunshakalan.jpg" alt="敦沙卡兰国家公园" height="300px"/></li>
										<li><img src="image/scen/feisijiudian.jpg" alt="吉隆坡菲斯酒店" height="300px"/></li>
										<li><img src="image/scen/kongzhongcantin.jpg" alt="吉隆坡空中餐厅" height="300px"/></li>
										<li><img src="image/scen/hongwu.jpg" alt="马六甲荷兰红屋" height="300px"/></li>
										<li><img src="image/scen/qingzhensi.jpg" alt="马六甲海峡清真寺" height="300px"/></li>
										<li><img src="image/scen/yaluhaitan.jpg" alt="沙巴丹绒亚路海滩" height="300px"/></li>
									</ul>
								</div>
							</section>
			...
			<img src="public/img/beauty.jpg" class="center-block" width="200px" height="150px"/>
