				...
				<div class="container">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="info.jsp">网红景点资讯</a></li>
						</ul>
						<!-- 全站搜索 -->
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="index_banner" id="banner_tabs">
							<ul>
								<li>
									<a href=""><img src="image/info/shabahuanchengdao.jpg" alt="沙巴环城岛" width="100%" height="340px"></a>
								</li>
								<li>
									<a href=""><img src="image/info/shanglingyangxiagu.jpg" alt="上羚羊峡谷" width="100%" height="340px"></a>
								</li>
								<li>
									<a href=""><img src="image/info/beach.jpg" alt="邦迪海滩网红泳池" width="100%" height="340px"></a>
								</li>
								<li>
									<a href=""><img src="image/info/pink.jpg" alt="粉红湖" width="100%" height="340px"></a>
								</li>
								<li>
									<a href=""><img src="image/info/simiao.jpg" alt="乌伦达努寺庙" width="100%" height="340px"></a>
								</li>
